...
<div class="">
  ...
  <div class="invoice row">
    ...
    <div class="line row row2">
      <div class="col-md-6 col-xs-6 padding-0 text-left">
        <h4><?php if ($voucher->effect == 'cr') {
            echo 'CREDITED TO';
          } else {
            echo 'PAID TO';
          }?></h4>
        <h2><?php echo $voucher->party->name.' [P/F No. '.intval($voucher->party->id).']'; ?></h2>
      </div>
    </div>
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          <td colspan="2" class="text-left" style="font-size:11px;text-transform:capitalize">EMPLOYEE DUES: <?php if ($voucher->party->balance->amount < 0) { 
      ...
      <p style="padding:10px 15px;"><?php if ($voucher->effect == 'cr') { echo 'POSTED';} else {echo 'RECEIVED';}?> BY: __________________________________ DATE: ___________ SIGN: _____________</p>
