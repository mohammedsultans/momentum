...
<div id="leadscont" class="">
  ...
  <div class="page-header">
    <h1 class="title">Project Activity Report</h1>
              ...
              <div class="panel-body">
                <form class="form-horizontal" id="frmr1">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <select class="selectpicker form-control" name="personell" id="employees1" multiple data-live-search="true">
                        <option data-icon="fa fa-user">Alex Mbaka</option>
                        <option data-icon="fa fa-user">Prince Munene</option>
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <form class="form-horizontal" id="frmr2">
              <div class="form-group">
                <label class="col-sm-2 control-label form-label">Claimant<span class="color10">*</span></label>
                <div class="col-sm-10">
                  <select class="selectpicker form-control" name="claimant" id="employees2" data-live-search="true">
                    <option data-icon="fa fa-user">Alex Mbaka</option>
                    <option data-icon="fa fa-user">Prince Munene</option>
                    <option data-icon="fa fa-user">Stanley Mikicha</option>
                    <option data-icon="fa fa-user">Jonathan Lukuli</option>
              ...
              <div class="form-group">                
                ...
                <div class="col-sm-10">
                  <select class="selectpicker form-control" name="category" id="expenses" style="padding-left:5px" data-live-search="true" >
